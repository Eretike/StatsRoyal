...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="ressources/css/cookiePolicy/cookiePolicy.css">
...
<div class="container-login100">
    <div class="wrap-login100">
        <h1>Cookie Policy for Stats Royal</h1>

        <p>This is the Cookie Policy for Stats Royal, accessible from stats-royal.com</p>
        ...
        <ul>
            ...
            <li>
                ...
                <p>When you submit data to through a form such as the one found on the index page or comment forms cookies may be set to remember your user details for future correspondence.</p>
            </li>
        ...
        <ul>
            <li>Email: stats.royal.contact@gmail.com</li>

        </ul>
        <a class="btn btn-primary" href="/index.jsp" role="button">Got it !</a>
    </div>
</div>
</div>
</body>
